...
sudo apt-get install -y publicsuffix unixodbc-dev zlib1g-dev
...
sudo apt-get install -y libegl-mesa0 libegl1 libegl1-mesa-dev libepoxy-dev libepoxy0 libevdev-dev libevdev2 
...
sudo apt-get install -y libpulse-dev libpulse-mainloop-glib0 libpulse0 librest-0.7-0 libsndfile1 
...
sudo apt-get install -y libxcb-xinerama0 libxcb-xinerama0-dev libxcb-xkb-dev libxcb-xkb1 libxkbcommon-dev 
